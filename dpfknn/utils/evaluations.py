...
This module provides evaluation metrics for clustering algorithms, including:
...
def safe_metric(func, default, *args, **kwargs):
    """Safely compute a metric, returning a default value if computation fails.
    ...
    Returns:
        The computed metric value, or default if computation fails
    """
    try:
